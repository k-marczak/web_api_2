    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "AMD", new DateTime(1991, 2, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Advanced Micro Devices" },
                    { 2, "IN", new DateTime(2001, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Intel" },
                    { 3, "NV", new DateTime(1994, 4, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Nvidia" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 5, 8, 9, 0, 0, 0, DateTimeKind.Unspecified), "Professional PC", 5, 24, 8.5 },
                    { 2, new DateTime(2026, 4, 15, 13, 30, 0, 0, DateTimeKind.Unspecified), "Home Office PC", 12, 24, 4.2000000000000002 },
                    { 3, new DateTime(2026, 3, 10, 10, 0, 0, 0, DateTimeKind.Unspecified), "Student PC", 20, 12, 6.0999999999999996 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "CPU/000111", 1, 1, "Gaming processor", "Ryzen 7" },
                    { "GPU/000222", 2, 2, "gaming graphics card", "RTX 4090" },
                    { "RAM/000333", 3, 3, "DDR5 RAM module 16GB", "16GB" }
                });
